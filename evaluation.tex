...
\chris{I think we mentioned most of this before? I am currently in favour of removing it. We need to shorten the paper anyway for space reasons.}
...
\chris{I think the following paragraph has value, but it should go to the complement interpretation/outcome section.}
%
...
\chris{Put this into conclusion. I think most of the points were raised before, but the question whether there exists a purely $k$-means++-based coreset is certainly an interesting one.}
