...
\begin{figure*}
  \caption{The costs of evaluated algorithms on 5 real-world datasets.}
  ...
  \newline \newline
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/coreset-costs-NYTimes+RP.pdf}
  }
  \subfloat{
...
\omar{TODO: Consider removing the entire section, or interweave it with the interpretation section.}
...
\subsubsection*{Random Projection vs PCA for Dimensionality Reduction}
\begin{itemize}
