...
\begin{enumerate}
\item Movement-based constructions: Such algorithms compute a clustering with $T$ points such that $\cost_A(T)\ll \opt$. The coreset guarantee then follows as a consequence of the triangle inequality. Popular examples from theory include~\cite{FrahlS2005,HaM04}. 
...
\chris{This sucks. Explain better.}
